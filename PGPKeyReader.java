...
public class PGPKeyReader {
	...
	public static PGPPublicKey readPublicKey(InputStream in, int algorithm)
        ...
        // Open the key ring
        PGPPublicKeyRingCollection coll = new PGPPublicKeyRingCollection(in , new JcaKeyFingerprintCalculator());
	...
	public static PGPSecretKey readSecretKey(InputStream in)
        ...
        // Open the key ring
        PGPSecretKeyRingCollection coll = new PGPSecretKeyRingCollection(in, new JcaKeyFingerprintCalculator());
	...
	public static PGPPrivateKey readPrivateKey(PGPSecretKey secret, char[] pass)
        ...
        try {
            key = secret.extractPrivateKey(new JcePBESecretKeyDecryptorBuilder().setProvider( new BouncyCastleProvider() ).build( pass));
        } catch (PGPException pgpe) {
